<section class="py-5 bg-stone-100">
    <div class="container py-5">
        <div class="row">
            <div class="col my-auto">
                <h2 class="text-5xl poppins-semibold">Transparent Pricing For All</h2>
                <p class="text-stone-900 text-lg mt-3">Know exactly what you’re paying for, no surprises.</p>
                <div class="text-5xl mt-4 animate-bounce">
