            ...
            <div class="col-11 mx-auto">
                <div class="py-4">
                    <div class="row gap-4" x-show="tab == 'Web Design'" x-cloak>
                        <div class="col bg-blue-200 shadow-md rounded-3 relative px-4 py-4">
                            <div>
                        ...
                        <div class="col my-auto">
                            <div class="row gap-4">
                                ...
                                <div class="col-12 bg-green-200 shadow-md rounded-3 px-4 py-5 d-flex">
                                    <div class="col-5 my-auto">
                    ...
                    <div class="row gap-4" x-show="tab == 'SEO'" x-cloak>
                        <div class="col bg-green-200 shadow-md rounded-3 relative px-4 py-2">
                            <div>
                    ...
                    <div x-show="tab == 'Technology Stack'" x-cloak>
                        <div class="row row-cols-2 g-4">
                            <div class="col">
                                <div class="d-flex gap-4 bg-indigo-200 shadow-md rounded-3 px-4 py-5">
                            ...
                            <div class="col">
                                <div class="d-flex gap-4 bg-green-200 shadow-md rounded-3 px-4 py-5">
                            ...
                            <div class="col">
                                <div class="d-flex gap-4 bg-purple-200 shadow-md rounded-3 px-4 py-5">
                                    <div class="col-4 my-auto">
                            ...
                            <div class="col">
                                <div class="d-flex gap-4 bg-teal-200 shadow-md rounded-3 px-4 py-5">
                            ...
                            <div class="col mx-auto">
                                <div class="d-flex gap-4 bg-yellow-200 shadow-md rounded-3 px-4 py-5">
                                    <div class="col-4 my-auto py-2">
